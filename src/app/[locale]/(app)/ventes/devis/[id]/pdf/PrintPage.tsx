  ...
  return (
    <>
      ...
      <div className="no-print">
        ...
        <a className="btn btn-primary" href={`/api/devis/${id}/pdf${docType === "bon-livraison" ? "?type=bon-livraison" : ""}${showImages ? "" : (docType === "bon-livraison" ? "&" : "?") + "images=0"}`} download={`${docLabel} - ${number}.pdf`}>
          ⬇ Télécharger PDF
        </a>
      </div>
